...
const uiStyles = `
.brand-lockup{display:flex;align-items:center;gap:10px;direction:rtl}.brand-logo{width:48px;height:48px;flex:0 0 48px;display:block;object-fit:cover;border-radius:12px;box-shadow:0 5px 16px rgba(44,20,72,.14);border:1px solid rgba(109,47,163,.12)}.brand-copy{display:flex;flex-direction:column;line-height:1.05}.brand-copy strong{font-size:14px;letter-spacing:.2px;color:#241a2d;font-weight:1000}.brand-copy span{font-size:10px;color:#76518e;font-weight:800;margin-top:4px}.hero-section{min-height:450px;background:radial-gradient(circle at 18% 50%,#f5edff 0,#fff 36%,#fff 100%)}.hero-inner{min-height:450px;grid-template-columns:minmax(0,.92fr) minmax(0,1.08fr);gap:34px}.hero-visual{height:auto;min-height:0;justify-content:center;overflow:visible}.hero-art{width:100%;max-width:860px;height:auto;aspect-ratio:2048/758;object-fit:cover;object-position:center;border-radius:20px;filter:drop-shadow(0 18px 30px rgba(62,26,92,.12))}.hero-copy{padding:30px 0 28px}.hero-copy h1{font-size:56px;line-height:1.08;letter-spacing:-1.8px}.hero-copy p{max-width:600px;font-size:17px;line-height:1.9}.hero-badge{box-shadow:0 7px 20px rgba(109,47,163,.08)}.hero-buttons{margin-top:22px}.hero-primary{min-width:150px}.hero-secondary{min-width:165px}.hero-trust{margin-top:24px}.site-header{height:82px}.site-header-inner{width:min(1460px,calc(100% - 56px));gap:30px}.header-brand{width:250px}.header-brand img{display:block}.main-nav{gap:34px}.header-actions{width:300px}.stages-section{padding-top:24px}.stages-inner{padding:22px 30px;border-radius:26px}.grade-card{height:126px}.why-section{padding-top:28px}.feature-card{min-height:132px;padding:17px}.bottom-cta{min-height:116px;border-radius:22px}
@media(max-width:1100px){.hero-inner{grid-template-columns:1fr 1fr;gap:20px}.hero-copy h1{font-size:48px}.hero-art{width:100%;height:auto}.main-nav{gap:18px}.header-brand{width:210px}.brand-logo{width:44px;height:44px;flex-basis:44px}}
  ...
  return (
    <main className="landing-page">
        ...
        <div className="site-header-inner">
          <div className="header-brand">
            <div className="brand-lockup">
              <img src="/logo.jpeg" alt="Eng Moaaz Ismail" className="brand-logo" />
      ...
      <section className="bottom-cta" id="contact">
        <div className="cta-brand"><div className="brand-lockup"><img src="/logo.jpeg" alt="Eng Moaaz Ismail" className="brand-logo" /><div className="brand-copy"><strong style={{color:'#fff'}}>ENG MOAAZ ISMAIL</strong><span style={{color:'#dfd0ed'}}>منصة معاذ إسماعيل التعليمية</span></div></div></div>
